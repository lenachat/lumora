...
import AllJournalEntries from '../journal-entries-list/journal-entries-list';
import { getDoc, doc } from 'firebase/firestore';
import { db } from '../../firebase';
import SingleJournalEntry from '../single-journal-entry/single-journal-entry';
import UpdateJournalEntry from '../edit-journal-entry/edit-journal-entry';
import ProfileView from '../profile-view/profile-view';
import AllFavoriteAffirmations from '../favorite-affirmations-list/favorite-affirmations-list';
import ResetPassword from '../reset-password-view/reset-password-view';
